		...
		<div>
			...
			<Modal className="text-light" isOpen={modal} toggle={toggle} {...args}>
				...
				<ModalBody className="bg-dark">
					...
					<div>
						<Badge color="danger">2. Challenging</Badge> Distorted pitch and
						speed
					</div>
					<div>
					...
					<div>
						<Badge color="primary">5. Easy</Badge> All of the pieces, just
						jumbled a little
					</div>
					<div>
					...
					<div>
						Time to see if you have the ear to pick out some of these classic
						songs!
					</div>
				</ModalBody>
